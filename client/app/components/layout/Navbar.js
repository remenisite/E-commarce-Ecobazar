     ...
     <nav className="container flex items-center justify-between py-[27px] gap-4">
            ...
            <div className="flex items-center">
              <ul className="flex items-center justify-center gap-[32px]">
                ...
                <li> <Link href={"/"} className="text-[16px] font-medium font-main text-[#666666] flex items-center gap-1"  >  Shop <MdKeyboardArrowDown /> </Link> </li>
                ...
                <li> <Link href={"/"} className="text-[16px] font-medium font-main text-[#666666] flex items-center gap-1"  >   About Us <MdKeyboardArrowDown /> </Link> </li>
              </ul>
            </div>
