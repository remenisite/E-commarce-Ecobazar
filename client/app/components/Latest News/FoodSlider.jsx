              ...
              >
                ...
                <div className="p-[24px]">
                  <div className="flex gap-[16px]">
                    <span className="text-[14px] flex items-center gap-1 font-normal font-main text-[#4D4D4D]">
                      <CiRuler /> {post.category}
                    </span>
                    <span className="text-[14px] flex items-center gap-1 font-normal font-main text-[#4D4D4D]">
                  ...
                  <p className="text-[18px] font-medium font-main text-text mt-[8px] mb-[20px]">
                    {post.text}
                  </p>
                  <a
                    href="#"
